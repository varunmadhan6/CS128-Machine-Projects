...
private:
   ...
   * Add any helper methods you may need
   */
  int Min(int idx_one, int idx_two, int row_, int** two_dim_array) const;
  int Min(int idx_one, int idx_two, int idx_three, int row_, int** two_dim_array) const;
  int* FindMinPathDynamicProgrammingHorz(int row_size, int col_size) const;
  int* FindMinPathDynamicProgrammingVert(int row_size, int col_size) const;
  int* Trace(int row_size, int col_size, int** arr_two_dim) const;
};
